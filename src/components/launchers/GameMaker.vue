      ...
      >
        <div class="card-body">
          ...
          <div id="homepage-intro-text" v-if="!$route.params.gSheetID">
            ...
            <div class="row mb-3">
              <div class="col-sm text-left">
                <p>
                  This app allows game designers to make, play, and share simple
                  storytelling games by putting their game content in a Google
                  Spreadsheet. For information on how to use and remix this app,
                  see the
                ...
                <p>
                  To see Story Synth in actions, watch this
                  <a href="https://youtu.be/TLQk3zyVyVI">Video Tour</a> or try
                  any of the following format demos:
                </p>
          ...
          <form>
            ...
            <div class="row mb-4">
              <div class="col-sm text-center">
                <router-link :to="constructURL(Shuffled, gSheetID, roomID)">
                  <button
                    :disabled="!gSheetID"
                    type="button"
                    class="btn btn-dark"
